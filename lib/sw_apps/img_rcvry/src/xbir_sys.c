...
#define CRL_APB_GEM0_REF_CTRL_OFFSET	(0XFF5E0050U)
...
static int Xbir_KVEthInit (void)
{
	...
	Xbir_Printf(DEBUG_PRINT_ALWAYS, "Xbir_KVEthInit XPAR_XEMACPS_0_BASEADDR: %08X\n\r", XPAR_XEMACPS_0_BASEADDR);
#endif
...
static int Xbir_KREthInit (void)
{
	...
	Xbir_Printf(DEBUG_PRINT_ALWAYS, "Xbir_KREthInit XPAR_XEMACPS_1_BASEADDR: %08X\n\r", XPAR_XEMACPS_1_BASEADDR);
#endif
#else
#ifdef XPAR_XEMACPS_0_BASEADDR
	EmacBaseAddr = XPAR_XEMACPS_0_BASEADDR;
	Xbir_Printf(DEBUG_PRINT_ALWAYS, "Xbir_KREthInit XPAR_XEMACPS_0_BASEADDR: %08X\n\r", XPAR_XEMACPS_0_BASEADDR);
#endif
#endif

	/* GEM clock settings */
//	Xbir_MaskWrite(CRL_APB_GEM1_REF_CTRL_OFFSET, 0x063F3F07U, 0x06010800U);
	Xbir_MaskWrite(CRL_APB_GEM0_REF_CTRL_OFFSET, 0x063F3F07U, 0x06010C00U);
...
//	Xbir_MaskWrite(IOU_SLCR_MIO_MST_TRI0_OFFSET, 0xFFFFFFFFU, 0xD4000000U); // 31,30,28,26
	Xbir_MaskWrite(IOU_SLCR_MIO_MST_TRI0_OFFSET, 0xFFFFFFFFU, 0x7D001000U); // 30-26,24,12
//	Xbir_MaskWrite(IOU_SLCR_MIO_MST_TRI1_OFFSET, 0xFFFFFFFFU, 0x00B3F020U); // 55,53,52,49-44,37
	Xbir_MaskWrite(IOU_SLCR_MIO_MST_TRI1_OFFSET, 0xFFFFFFFFU, 0xF033FF20U); // 63-60,53,52,49-40,37
//	Xbir_MaskWrite(IOU_SLCR_MIO_MST_TRI2_OFFSET, 0x00003FFFU, 0x0000000BU); // 67,65,64
	Xbir_MaskWrite(IOU_SLCR_MIO_MST_TRI2_OFFSET, 0x00003FFFU, 0x0000100FU); // 76,67-64
//	Xbir_MaskWrite(IOU_SLCR_BANK1_CTRL5_OFFSET, 0x00003FFFU, 0x0000357FU); // 51,50,48,46,44-38
	Xbir_MaskWrite(IOU_SLCR_BANK1_CTRL5_OFFSET, 0x00003FFFU, 0x00000FFCU); // 49-40
...
#ifdef XPAR_XEMACPS_1_BASEADDR
	EmacBaseAddr = XPAR_XEMACPS_1_BASEADDR;
	Xbir_Printf(DEBUG_PRINT_ALWAYS, "Xbir_KDEthInit XPAR_XEMACPS_1_BASEADDR: %08X\n\r", XPAR_XEMACPS_1_BASEADDR);
#endif
#else
#ifdef XPAR_XEMACPS_0_BASEADDR
	EmacBaseAddr = XPAR_XEMACPS_0_BASEADDR;
	Xbir_Printf(DEBUG_PRINT_ALWAYS, "Xbir_KDEthInit XPAR_XEMACPS_0_BASEADDR: %08X\n\r", XPAR_XEMACPS_0_BASEADDR);
#endif
#endif
...
#ifdef XPAR_XEMACPS_0_BASEADDR
	EmacBaseAddr = XPAR_XEMACPS_0_BASEADDR;
	Xbir_Printf(DEBUG_PRINT_ALWAYS, "Xbir_SCEthInit XPAR_XEMACPS_0_BASEADDR: %08X\n\r", XPAR_XEMACPS_0_BASEADDR);
#endif
